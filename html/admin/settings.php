<!-- HTML GOES HERE -->
<?php if( $partner_id != "") { ?>
<style>#upshare_notice {display: none;}</style>
<div class="wrap">
	<section id="upheader">
		<div id="upwrapper">
	...
	<section id="partner-id">
		<div id="upwrapper">
			<div class="partner-id-main-contant1">
				<h1>VISIT YOUR DASHBOARD TO CUSTOMIZE YOUR VIRAL FOLLOW BUTTONS</h1>
...
Viral Buttons in 2 Easy Steps</h1>
					<p>
						Start Getting More Follows in 30 Seconds - 100% Free.					
					</p>
...
<div id="upwrapper">
  ...
  <div class="row upshare-upblog">
    <div class="col-md-6">
      ...
      <p>Follow buttons pinned to the edge of the visitor’s screen as they scroll</p>
    </div>
    <div class="col-md-6">
      
    <img src="<?php echo $this->_plugin_url . '/images/upshare.jpg' ?>" class= 'img-responsive' style="height:215px" />
    ...
    <div class="col-md-12 text-center">
      ...
      <p>With dozens of customization options, you can <strong>get more followers, and look good doing it.</strong></p>
